...
##############################
    ...
    ##农历地支
    var $mtwelve = array("null", "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥");
    ##生肖
    var $mzodiac = array("null", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪");
    ##农历月份
...
##############################
    ...
    function Cal($Year = null, $Month = null, $Day = null)
    {
        if (empty($Year)) {
            $Year = date('Y');
        }
        ...
        return array("year" => $this->mten[$this->everyCMonth[$Par["m"]][14]] . $this->mtwelve[$this->everyCMonth[$Par["m"]][15]],
            "zodiac" => $this->mzodiac[$this->everyCMonth[$Par["m"]][15]],
            "month" => $cMonth,
            "day" => $this->mday[$md],
            "week" => $week);
    }
