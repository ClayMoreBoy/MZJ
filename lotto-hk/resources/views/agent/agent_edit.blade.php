    ...
    <div role="main" class="ui-content">
        <div style="margin:-1em -.5em;">
            <div data-role="controlgroup" data-type="horizontal" class="ui-mini">
                ...
                <input type="text" id="phone" size="20" data-btn="phone_btn"
                       value="{{ request('phone',$account->phone) }}"
            ...
            <div data-role="controlgroup" data-type="horizontal" class="ui-mini">
                ...
                <input type="text" id="name" size="20" data-btn="name_btn"
                       value="{{ request('name',$account->name) }}"
                       data-wrapper-class="controlgroup-textinput ui-btn">
                <button id="name_btn" onclick="updateData('name')" disabled="disabled">确定</button>
            </div>
            <div data-role="controlgroup" data-type="horizontal" class="ui-mini">
                <button disabled="disabled">微信号</button>
                <input type="text" id="wx_account" size="20" data-btn="wx_account_btn"
                       value="{{ request('wx_account',$account->wx_account) }}"
                       data-wrapper-class="controlgroup-textinput ui-btn">
                <button id="wx_account_btn" onclick="updateData('wx_account')" disabled="disabled">确定</button>
            </div>
            <input type="hidden" id="wx_qr"
                   value="{{ request('wx_qr',$account->wx_qr) }}">
            <div class="ui-grid-a">
                <div class="ui-block-a">
                    <img id="img_container" src="{{ request('wx_qr',$account->wx_qr) }}" style="width: 80%">
                </div>
