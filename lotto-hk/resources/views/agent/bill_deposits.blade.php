        ...
        <div style="margin:-1.5em -1em;">
                    ...
                    <div class="ui-grid-solo">
                        <div class="ui-block-a">
                            <div class="ui-bar ui-bar-b">
                                ...
                                <a href="/agent/bill/deposits/" class="ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all ui-btn-inline"></a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                <a href="{{ $deposits->url(1) }}"
                   class="ui-btn ui-corner-all {{ $deposits->currentPage()==1?'ui-state-disabled':'' }}"> 首页 </a>
                <a href="{{ $deposits->previousPageUrl() }}"
                   class="ui-btn ui-corner-all {{ $deposits->currentPage()==1?'ui-state-disabled':'' }}"> 上一页 </a>
                <a href="#" class="ui-btn ui-corner-all">{{ $deposits->currentPage() }}</a>
                <a href="{{ $deposits->nextPageUrl() }}"
                   class="ui-btn ui-corner-all {{ $deposits->currentPage()==$deposits->lastPage()?'ui-state-disabled':'' }}">
                    下一页 </a>
